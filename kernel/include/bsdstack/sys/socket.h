...
#define SOCK_PACKET	10		/* DHD added to support packet */
/*
...
#define AF_PACKET	37		/* DHD added to support LINUX PACKET */
#define	AF_MAX		38		/* DHD changed MAX from 37 to 38 */
#endif
...
#define PF_PACKET	AF_PACKET	/* DHD added to support LINUX PACKET */
...
size_t	recvfrom(int, void *, size_t, int, struct sockaddr * __restrict, socklen_t * __restrict);
size_t	recvmsg(int, struct msghdr *, int);
size_t	send(int, const void *, size_t, int);
size_t	sendto(int, const void *,
	    size_t, int, const struct sockaddr *, socklen_t);
size_t	sendmsg(int, const struct msghdr *, int);
