...
static int Aflag = 0;
static int	aflag;		/* show all sockets (including servers) */
static int	bflag;		/* show i/f total bytes in/out */
static int	dflag;		/* show i/f dropped packets */
static int	gflag;		/* show group (multicast) routing or stats */
static int	iflag;		/* show interfaces */
static int	Lflag;		/* show size of listen queues */
static int	mflag;		/* show memory stats */
static int	numeric_addr;	/* show addresses numerically */
static int	numeric_port;	/* show ports numerically */
static int pflag;	/* show given protocol */
static int	rflag;		/* show routing tables (or routing stats) */
static int	sflag;		/* show protocol statistics */
static int	tflag;		/* show i/f watchdog timers */
static int	Wflag;		/* wide display */
static int	zflag;		/* zero stats */

static int	interval;	/* repeat interval for i/f stats */
...
kgetsa(struct sockaddr *dst)
{
    ...
    //kget(dst, pt_u.u_sa);
    memcpy(&pt_u.u_sa, dst, sizeof(pt_u.u_sa));
